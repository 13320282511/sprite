...
function Scroll(el, options) {
	...
	if (this.options.role === 'slider') {
		...
		if (this.options.indicator == 'in') {
		...
		}if(this.options.indicator == 'wrap'){
			var temp = '<ul class="ui-slider-indicators2">';
			...
			temp += '</ul>';
			$(this.wrapper).parent().append(temp);
			this.indicator = $('.ui-slider-indicators2')[0];	
		}
